"""
UI rendering helpers: cards, metric tiles, chart layouts, provenance labels,
and the shared Virtual Pack Builder widget.

Extracted from utils.py to separate rendering logic from cache/data helpers.
"""
...
from _design_tokens import (
    CARD_BG, CARD_BORDER, FEATURE_LABELS, PACK_BUNDLE_KEY,
)
...
def render_regenerate_report_button(bundle: dict, org_id: "int | None", key_suffix: str) -> None:
    """\"Regenerate this report\" — replays the recorded pipeline behind a bundle."""
...
def render_pack_builder(featured_dfs: dict, bundles: dict, key_prefix: str) -> None:
    """Shared Virtual Pack Builder — cell selection, topology, pack metrics."""
