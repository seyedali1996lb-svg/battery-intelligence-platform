...
from utils import _action_bar, _md_html, base_layout
from chemistry_profiles import ChemistryProfile
from design_system import make_badge, BADGE_VALIDATED, BADGE_ESTIMATE, BADGE_ILLUST
from _pages._consequences_solar import render_solar_storage_sizing
...
def page_consequences(
    ...
    render_solar_storage_sizing(selected, fin["current_kwh"])
