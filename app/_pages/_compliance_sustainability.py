"""Compliance page — Sustainability tab.

Extracted from compliance.py's page_sustainability() (was 1,059 lines --
the 4th largest file in app/_pages/). This function was already fully
self-contained (only needs selected/df, no shared state with the
Passport/Reports/Regulatory-Alerts tabs also defined in that file), so
this is a clean move with no parameter re-threading. page_compliance()
imports it here for the "Sustainability" tab.
"""
