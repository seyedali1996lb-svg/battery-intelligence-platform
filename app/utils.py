...
def render_regenerate_report_button(bundle: dict, org_id: "int | None", key_suffix: str) -> None:
    ...
    import_page.py's upload pipeline) — absent only for a bundle loaded
    from a disk cache written before this feature existed, handled below
    as "nothing to replay" rather than a crash.
    """
