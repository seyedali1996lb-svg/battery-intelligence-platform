...
set: `nasa`/LiCoO2 → NCA_Kim2011 and `severson2019`/LFP → Chen2020. Everything
...
ANCHOR_PARAM_SETS: dict[tuple[str, str], str] = {
    ("nasa", "LiCoO2"): "NCA_Kim2011",
    ("severson2019", "LFP"): "Chen2020",
}
...
def _param_set_for_cell(df: pd.DataFrame, cell_id: "str | None" = None) -> "str | None":
    ...
    chemistries ("NCA_Kim2011" for the NASA LiCoO₂ cells, "Chen2020" for the
    Severson LFP cells).
    """
...
# Same strings the application's pybamm_rul._CHEM_LABEL carries, for the same two
