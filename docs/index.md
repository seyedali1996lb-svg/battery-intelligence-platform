...
- [Validation harness](harness.md) — grade *any* forecaster by this library's rules (leave-cell-out, label provenance, conformal intervals, metric gate, sealed bundles) and read the claims it withholds; run someone else's model in a sandbox; also a page in the demo app (**Analyse → Bring your own model**).
